...
### Genomic Signatures (WGD, Aneuploidy Scores, Ploidy, ...)

**URL:** https://depmap.org/portal/data_page/?tab=allData&releasename=DepMap%20Public%2024Q2&filename=OmicsSignatures.csv

**Location:** `./Data/External/CopyNumber/DepMap/OmicsSignatures.csv`
...
**Columns:** MSIScore (float), Ploidy (float), CIN (float), WGD (binary, 1 indicates presence of WGS, 0 otherwise), LoHFraction (float), Aneuploidy (int)
...
**URL:** https://depmap.org/portal/data_page/?tab=allData&releasename=DepMap%20Public%2024Q2&filename=OmicsCNGene.csv

**Location:** `./Data/External/CopyNumber/DepMap/OmicsCNGene.csv`
...
**URL:** https://depmap.org/portal/data_page/?tab=allData&releasename=DepMap%20Public%2024Q2&filename=OmicsAbsoluteCNGene.csv

**Location:** `./Data/External/CopyNumber/DepMap/OmicsAbsoluteCNGene.csv`
...
### CPTAC (AscatNGS copy number calls)
