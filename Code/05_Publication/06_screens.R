...
volcano_dep_corr <- df_crispr_buf %>%
  ...
  labs(x = "Correlation (Dependency Score, Buffering Ratio)",
       color = "Cancer Driver")
...
figure6_sub1 <- cowplot::plot_grid(volcano_dep_corr, gene_corr_plots$EGFR, gene_corr_plots$CDK6,
                                   gene_corr_plots$ELMO2, gene_corr_plots$BRAT1,
                                   labels = c("A", "B", "C", "D", "E"),
